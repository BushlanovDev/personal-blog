<footer class="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
    <div class="container">
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                <div class="mb-12 max-w-[360px] lg:mb-16">
                    <a class="mb-8 inline-block" href="/">
                        <img alt="logo" loading="lazy" width="140" height="30" decoding="async" data-nimg="1" class="w-full dark:hidden" style="color:transparent" src="/images/logo/logo-2.svg">
                        <img alt="logo" loading="lazy" width="140" height="30" decoding="async" data-nimg="1" class="hidden w-full dark:block" style="color:transparent" src="/images/logo/logo.svg">
                    </a>
                    <p class="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lobortis.</p>
                    <div class="flex items-center">
                        <a href="/" aria-label="social-link" target="_blank" rel="noopener noreferrer" class="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                        ...
                        <a href="/" aria-label="social-link" target="_blank" rel="noopener noreferrer" class="text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
        ...
        <div class="py-8">
            <p class="text-center text-base text-body-color dark:text-white">Bushlanov Dev &copy; {{date('Y')}}</p>
        </div>
    </div>
